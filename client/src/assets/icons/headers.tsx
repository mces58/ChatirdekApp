...
const PencilWriteIcon: React.FC<HeaderIconProps> = (props) => {
...
const GroupPeopleIcon: React.FC<HeaderIconProps> = (props) => {
  const { width, height, strokeWidth = 1, opacity = 1 } = props;
  const { theme } = useTheme();
...
const EarthIcon: React.FC<HeaderIconProps> = (props) => {
  const { width, height, strokeWidth = 1, opacity = 1 } = props;
  const { theme } = useTheme();
...
const SettingLeafIcon: React.FC<HeaderIconProps> = (props) => {
  const { width, height, strokeWidth = 1, opacity = 1 } = props;
  const { theme } = useTheme();
