...
const FontSizeIcon: React.FC<IconProps> = (props) => {
...
const PaintBucketIcon: React.FC<IconProps> = (props) => {
  const { width, height, customColor, strokeWidth = 2.5, opacity = 1 } = props;
  const { theme } = useTheme();
...
const BroomIcon: React.FC<IconProps> = (props) => {
